...
echo "Installing amplifierd..."
uv tool install --force --upgrade "git+https://github.com/payneio/amplifier@main#subdirectory=amplifierd"

echo "Installing Amplifier CLI..."
uv tool install --force --upgrade "git+https://github.com/payneio/amplifier@main#subdirectory=amplifier-cli"

echo ""
echo "=== Install complete ==="
echo ""
echo "To get started:"
echo "  run 'amplifier init'"
echo ""
