...
The **core** bundle is the representative for the Amplifier kernel. The kernel provides MECHANISMS only, never POLICIES. In this monorepo, the kernel is implemented as `amplifier_lib/core/` (~480 lines), a simplified Python-native version of the original upstream kernel.
