...
# Copy an .ANS file
cp COOL-ART.ANS amplifier-app-cli/amplifier_cli/banners/art/epic.ans
...
```bash
cd amplifier-app-cli/amplifier_cli/banners/art
ansi-view *.ans
```
...
```python
from amplifier_cli.banners import load_banner
