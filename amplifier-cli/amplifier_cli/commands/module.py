...
def list_modules(type: str):
    ...
    from amplifier_lib.core.loader import ModuleLoader
...
def module_add(module_id: str, source: str | None, scope_flag: str | None):
    ...
    if source and source.startswith("git+"):
        from amplifier_cli.lib.sources_compat import GitSource
...
def _get_local_override_names() -> set[str]:
    ...
    """
    from amplifier_cli.lib.sources_compat import FileSource
...
async def _module_validate_async(
    ...
    from amplifier_lib.core.validation import ContextValidator
    from amplifier_lib.core.validation import HookValidator
    from amplifier_lib.core.validation import OrchestratorValidator
    from amplifier_lib.core.validation import ProviderValidator
    from amplifier_lib.core.validation import ToolValidator
