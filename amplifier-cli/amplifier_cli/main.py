...
from amplifier_cli.utils.help_formatter import AmplifierGroup
...
def _create_prompt_session(get_active_mode: Callable | None = None) -> PromptSession:
    ...
    """
    from amplifier_cli.project_utils import get_project_slug
...
async def interactive_chat(
    ...
    try:
        ...
        if turn_count > 0:
            hooks = session.coordinator.get("hooks")
            if hooks:
                from amplifier_lib.core.events import SESSION_END
